 ...
 */
class DrawableReplace(config: ResToolsConfig) : BaseFolderResReplace(config) {

    /**
     * 资源名称
     */
    private val RES_TYPE_NAME = "drawable"
    ...
    override val javaRegex: String = """(R(\s*?)\.(\s*?)drawable(\s*?)\.(\s*?))(\w+)"""
    override val xmlRegex: String = """(@drawable/)(\w+)"""
